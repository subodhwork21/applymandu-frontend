...
const Footer = () => {
  return (
    <footer className="bg-patternSecondary text-white py-12 2xl:px-0 px-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">
              <Image src={"./inverted-main-logo.svg"} alt="logo" width={73} height={49} className="grayscale-50" />
            </h3>
